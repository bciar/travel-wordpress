...
class Transfers_Plugin_WooCommerce extends Transfers_BaseSingleton {
	...
	function woocommerce_before_order_itemmeta($item_id, $item, $_product) {
		...
		if ($booking_entry != null && $variation != null) {
			...
			$destination_from_title_id = $attributes['attribute_' . TRANSFERS_WOOCOMMERCE_DESTINATION_FROM_ATT];
			$destination_to_title_id = $attributes['attribute_' . TRANSFERS_WOOCOMMERCE_DESTINATION_TO_ATT];
			$transport_type_title_id = $attributes['attribute_' . TRANSFERS_WOOCOMMERCE_TRANSPORT_TYPE_ATT];
